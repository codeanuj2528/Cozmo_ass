...
Both are fixed; `known_failure_modes.md` §5 and `docs/design.md` §3 have the details. Fix loop
round 3 then took it from 26.90 to 20.91 m²: the corridor, which had run on across the passage beyond
it and into a bathroom at 8.82 m², now ends where its walls end, and a walled space none of the scans
saw into left the lobby (`fixloop/round3/`).
